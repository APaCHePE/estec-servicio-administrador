...
public class MensajeVm{
	 ...
	 */
	public List<CuentaMensaje> getCuentaDestinovm() {
		return cuentaDestinovm;
	}
	 ...
	 */
	public void setCuentaDestinovm(List<CuentaMensaje> cuentaDestinovm) {
		this.cuentaDestinovm = cuentaDestinovm;
	}
