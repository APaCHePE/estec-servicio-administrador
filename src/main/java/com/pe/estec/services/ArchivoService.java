...
public interface ArchivoService {
	...
	public InputStreamResource obtenerEstadoCuentaRep(Integer secuencia, List<Asiento> listComprobante, Integer igv, String detraccion, String distribucion) throws Exception ;
}
