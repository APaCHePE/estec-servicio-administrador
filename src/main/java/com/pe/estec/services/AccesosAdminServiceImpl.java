...
import com.pe.estec.repository.AccesoAdminRepository;
import com.pe.estec.repository.AccesosRepository;

@Service
public class AccesosAdminServiceImpl implements AccesosAdminService {

	@Autowired
	private AccesosRepository accesoRepository;

	@Autowired
	private AccesoAdminRepository userDao;
	...
	public ServiceResult<Proveedor> authentication(String usuario, String pass) {
		...
		try {
			List<Proveedor> proveedorAuth = userDao.listarEmpleado(null, null, usuario, null, null);
